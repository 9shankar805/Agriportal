...
export default function MessagesSection() {
  ...
  return (
    <div className="fade-up">
      <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-4" style={{ height: 'calc(100vh - 140px)', minHeight: 480 }}>
        {/* Conversation list */}
        ...
        <div className="bg-white rounded-xl shadow-sm flex flex-col overflow-hidden">
          {!activeConv ? (
            ...
            <>
              ...
              {/* Messages */}
              <div ref={bodyRef} className="flex-1 overflow-y-auto p-5 bg-green-50/30 flex flex-col gap-3">
                {msgs.length === 0 ? (
